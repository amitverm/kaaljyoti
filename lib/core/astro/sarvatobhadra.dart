...
const List<List<SbcCell>> sbcGrid = [
  // r0
  [
    SbcCell.vowel('ī'), SbcCell.nak(23), SbcCell.nak(24), SbcCell.nak(25),
    SbcCell.nak(26), SbcCell.nak(27), SbcCell.nak(0), SbcCell.nak(1),
    SbcCell.vowel('a'),
  ],
  // r1
  [
    SbcCell.nak(22), SbcCell.vowel('ṝ'), SbcCell.consonant('ga'),
    SbcCell.consonant('sa'), SbcCell.consonant('da'), SbcCell.consonant('cha'),
    SbcCell.consonant('la'), SbcCell.vowel('u'), SbcCell.nak(2),
  ],
  // r2  (r2c7 'chha': sources differ on this one consonant cell —
  // confirm against Parashar Light's SBC if it matters for name-vedha.)
  [
    SbcCell.nak(21), SbcCell.consonant('kha'), SbcCell.vowel('ai'),
    SbcCell.sign(ZodiacSign.aquarius), SbcCell.sign(ZodiacSign.pisces),
    SbcCell.sign(ZodiacSign.aries), SbcCell.vowel('ḷ'),
    SbcCell.consonant('chha'), SbcCell.nak(3),
  ],
  // r3
  [
    SbcCell.nak(20), SbcCell.consonant('ja'), SbcCell.sign(ZodiacSign.capricorn),
    SbcCell.vowel('aḥ'), SbcCell.tithiVara('Fri·Rikta'), SbcCell.vowel('o'),
    SbcCell.sign(ZodiacSign.taurus), SbcCell.consonant('va'), SbcCell.nak(4),
  ],
  // r4
  [
    SbcCell.nak(19), SbcCell.consonant('bha'),
    SbcCell.sign(ZodiacSign.sagittarius), SbcCell.tithiVara('Thu·Jaya'),
    SbcCell.tithiVara('Sat·Purna'), SbcCell.tithiVara('Sun/Tue·Nanda'),
    SbcCell.sign(ZodiacSign.gemini), SbcCell.consonant('ka'), SbcCell.nak(5),
  ],
  // r5
  [
    SbcCell.nak(18), SbcCell.consonant('ya'), SbcCell.sign(ZodiacSign.scorpio),
    SbcCell.vowel('aṁ'), SbcCell.tithiVara('Mon/Wed·Bhadra'),
    SbcCell.vowel('au'), SbcCell.sign(ZodiacSign.cancer),
    SbcCell.consonant('ha'), SbcCell.nak(6),
  ],
  // r6
  [
    SbcCell.nak(17), SbcCell.consonant('na'), SbcCell.vowel('e'),
    SbcCell.sign(ZodiacSign.libra), SbcCell.sign(ZodiacSign.virgo),
    SbcCell.sign(ZodiacSign.leo), SbcCell.vowel('ḹ'),
    SbcCell.consonant('Da'), SbcCell.nak(7),
  ],
  // r7
  [
    SbcCell.nak(16), SbcCell.vowel('ṛ'), SbcCell.consonant('ta'),
    SbcCell.consonant('ra'), SbcCell.consonant('pa'), SbcCell.consonant('Ta'),
    SbcCell.consonant('ma'), SbcCell.vowel('ū'), SbcCell.nak(8),
  ],
  // r8
  [
    SbcCell.vowel('i'), SbcCell.nak(15), SbcCell.nak(14), SbcCell.nak(13),
    SbcCell.nak(12), SbcCell.nak(11), SbcCell.nak(10), SbcCell.nak(9),
    SbcCell.vowel('ā'),
  ],
];
